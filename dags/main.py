...
def write_to_raw_data():
    ...
    db_ip = "mysql" # "10.152.183.124:3307"
    ...
    cursor = conn.cursor()
    engine = create_engine(f"mysql+mysqlconnector://airflow:airflow@{db_ip}/airflow")
...
def write_to_clean_data():
    ...
    df.drop(['examide','citoglipton','glimepiride_pioglitazone','max_glu_serum','A1Cresult'], axis='columns', inplace=True)
...
def train_models():
    ...
    mlflow.set_experiment("mlflow_tracking_examples1")
